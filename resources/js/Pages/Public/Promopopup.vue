<template>
    <Transition name="fade-premium">
        <div v-if="isVisible" class="promo-premium-overlay" @click.self="closePopup" style="z-index: 99999;">
...
onUnmounted(() => {
    ...
    document.body.style.overflow = ''; // Por seguridad si se cambia de página de golpe
});
</script>