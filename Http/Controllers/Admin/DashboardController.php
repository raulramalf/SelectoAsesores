    ...
    public function index()
    {
        return Inertia::render('Admin/Dashboard', [
            'stats' => [
                ...
                'recent_documents' => Document::count(),
                'total_news' => News::count(),
                'new_messages' => ContactMessage::whereNull('read_at')->count(), 
            ],
            ...
            'actividad' => collect()
                ...
                ->sortByDesc('fecha')->take(6)->values(),
        ]);
    }
        ...
        return Inertia::render('Admin/Citas', [
            'citas' => Appointment::with('client')
                ...
                ->map(fn($c) => [
                    ...
                    'es_invitado' => is_null($c->client_id),
                    'razon'       => $c->reason ?? '—',
                    'fecha'       => $c->date ? $c->date->format('Y-m-d') : null,
                    'time'        => $c->time,
